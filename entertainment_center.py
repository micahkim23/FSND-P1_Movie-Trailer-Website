...
t1_jump_street = media.Movie("21 Jump Street",
                             "Two undercover officers have to shut down a drug operation at a high school",
...
inside_out = media.Movie("Inside Out", "Meet the voices inside a young girl's head",
                             "https://upload.wikimedia.org/wikipedia/en/0/0a/Inside_Out_(2015_film)_poster.jpg",
                             "https://www.youtube.com/watch?v=seMwpP0yeu4")
transformers_age_of_extinction = media.Movie("Transformers Age of Extinction", "The Autobots must defeat the Decepticons",
...
mockingjay = media.Movie("Mockingjay", "The capitol needs to be destroyed",
                           "https://upload.wikimedia.org/wikipedia/en/6/63/MockingjayPart1Poster3.jpg",
                           "https://www.youtube.com/watch?v=3PkkHsuMrho")

#array of movies
movies = [the_interview, avengers, t1_jump_street, inside_out, transformers_age_of_extinction, mockingjay]
